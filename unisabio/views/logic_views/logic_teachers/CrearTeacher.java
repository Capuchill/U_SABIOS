...
public class CrearTeacher {
    private static final boolean EXIT = false;
    
    private CrearTeacher(){}
                ...
                if(typeDocument == 99) {
                    ...
                    if(typeDocument > 0 && typeDocument < 5) {
                        ...
                        if(String.valueOf(dniNumber).length() > 0 && String.valueOf(dniNumber).length() < 11)  {
                            ...
                            Teacher teacher = new Teacher(dniType, dniNumber, pName, sName, pLastName, sLastName);
                            ...
                            teacher.setInfoAdicional(residingCity, addressHome, phone, bornDate, sex);
    
                            Main.teacherServices.crearTeacher(teacher);
                        }
                        else {
                            ErrorU.errSizeNum();
                            Main.input.nextLine();
